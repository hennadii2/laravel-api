...
<body style="background-color:#fff;">
	<!-- Site Wraper -->
	<div class="home-section"  style="word-wrap:break-word;">

		<div class="row" style="margin-right: 0;">
			@include('admin.z_login_cover')
			<div class="col-md-8 col-sm-6 col-xs-12">
				<div class="row privacy--policy" style="margin-right: 0;">
					...
					<p>We understand that your privacy is important to you, that&rsquo;s why we had our legal team write this ridiculously long explanation for how we are legally bound to keeping your personal information where it belongs to yourself.</p>
						...
						<h4>With whom may the information be shared?</h4>
						...
						<p>Visitors and Authorized Customers may opt out of receiving unsolicited information from or being contacted by us and/or our vendors and affiliated agencies by responding to emails as instructed, or by contacting us at: help@TopShelfMenu.us</p>
						...
						<h4>How does Invoyce use login information?</h4>
						...
						<p>Visitors and Authorized Customers may contact us to update Personally Identifiable Information about them or to correct any inaccuracies by emailing us at help@TopShelfMenu.us.</p>
						<h4>Can a Visitor delete or deactivate Personally Identifiable Information collected by the Site?</h4>
						<p>We provide Visitors and Authorized Customers with a mechanism to delete/deactivate Personally Identifiable Information from the Site's database by contacting help@TopShelfMenu.us. However, because of backups and records of deletions, it may be impossible to delete a Visitor's entry without retaining some residual information. An individual who requests to have Personally Identifiable Information deactivated will have this information functionally deleted, and we will not sell, transfer, or use Personally Identifiable Information relating to that individual in any way moving forward.</p>
						...
						<p>TOP SHELF MENU LLC</p>
						<p>2121 6th Avenue N616
						<br>
							Seattle, WA 98121
						</p>
						<p>Last updated: March 4, 2018</p>
				</div>
			</div>
		</div>

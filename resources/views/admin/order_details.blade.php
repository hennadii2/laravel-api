...
$customer=DB::table('customer')->where('cus_id', '=', $order_deatils->user_id)->first();
?>
...
<tr>
<td class="no_brdr bg__td" valign="top" style="width: 20%;">First Name: </td>
<td class="no_brdr" valign="top" style="width: 80%;">{{ucfirst($order_deatils->fname)}} {{ucfirst($order_deatils->lname)}}</td>
</tr>

<tr>
<td class="no_brdr bg__td" valign="top">Email: </td>
<td class="no_brdr" valign="top">{{$order_deatils->email}}</td>
</tr>
...
<td class="no_brdr" valign="top">{{$order_deatils->phone}}</td>
</tr>
<tr>
<td class="no_brdr bg__td" valign="top">Address:</td>
<td class="no_brdr 3_brder"> {{$order_deatils->address}}</td>
</tr>


<tr>
<td class="no_brdr bg__td" valign="top">City:</td>
<td class="no_brdr 3_brder"> {{$order_deatils->city}}</td>
</tr>

<tr>
<td class="no_brdr bg__td" valign="top">State: </td>
<td class="no_brdr" valign="top">{{$order_deatils->state}} </td>
</tr>
<tr>
<td class="no_brdr bg__td" valign="top">Zipcode:</td>
<td class="no_brdr 3_brder"> {{$order_deatils->zip_code}}</td>
</tr>
...
<div class="order___date">Date: <span><?php echo date('m-d-Y', strtotime($order_deatils->order_date));?></span></div>
</div>
</div>
...
<?php
  ...
  ->where('order_id','=', $order_deatils->orderid)->get();

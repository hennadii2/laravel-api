...
<div class="page-breadcrumb mb-30"> <a href="{{URL::to('/')}}/admin/index">Setting</a>/<span>Brand</span> </div>
...
<tr>
<td>{{$value->name}} </td>
<td><a href="{{URL::to('/')}}/admin/brand/{{$value->brand_id}}" class="tt_green_text"><i class="fa fa-pencil"></i> Edit</a> |
<a href="{{URL::to('/')}}/admin/brand_delete/{{$value->brand_id}}" class="tt_green_text red_text"><i class="fa fa-trash"></i> Delete</a></td>
</tr>
@endforeach
